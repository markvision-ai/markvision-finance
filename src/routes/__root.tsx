...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "MarkVision" },
      { name: "format-detection", content: "telephone=no" },
      { property: "og:title", content: "MarkVision Finance" },
      { property: "og:description", content: "Расходы, доходы, цели и кредиты в одном месте." },
